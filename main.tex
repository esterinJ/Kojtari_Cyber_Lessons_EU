...
\begin{titlepage}
   % \begin{center}
    %    \vspace*{0.2cm}
     %   {\fontsize{19pt}{20pt}\selectfont Alma Mater Studiorum - Universit{\ag} di Bologna\par}
    %  \noindent\hrulefill
      %  \vspace{0.8cm}
    ...
    \begin{center}
        \includegraphics[width=6cm]{logo.png} % Add your logo file (replace "logo.png" with the actual filename)
        \vspace*{0.2cm}
...
% dedicaation
\clearpage % This ensures any pending figures or tables are printed before the empty page
\thispagestyle{empty} % Removes headers, footers, and page numbers for the empty page
\begin{flushright}
